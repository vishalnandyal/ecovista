...
cap = cv2.VideoCapture('/home/sevengods/Documents/WMS&LD/Litter_detection/yolov8_model/data/test/3.mp4') # put 0 for webcam

frame_width = int(cap.get(3))
frame_height = int(cap.get(4))

out = cv2.VideoWriter('3.mp4', cv2.VideoWriter_fourcc('M','J','P','G'), 1, (frame_width, frame_height))
...
colors = [(0, 128, 0), (0, 0, 255), (255, 165, 0), (255, 0, 0)]  # Define colors for each class
